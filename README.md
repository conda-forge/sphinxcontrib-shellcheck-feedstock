About sphinxcontrib-shellcheck
==============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxcontrib-shellcheck-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15283&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-shellcheck-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-shellcheck` can be installed with:

```
conda install sphinxcontrib-shellcheck
```

It is possible to list all of the versions of `sphinxcontrib-shellcheck` available on your platform with:
